...
const Gifts = () => {
  ...
  const giftsData = [    // Lua de Mel
    ...
    { id: 8, name: 'Jantar temático italiano', price: 447.81, category: 'Lua de Mel', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=600&auto=format&fit=crop' },
