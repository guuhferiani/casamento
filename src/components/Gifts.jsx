...
const Gifts = () => {
  ...
  const giftsData = [    // Lua de Mel    // Lua de Mel
    ...
    { id: 8, name: 'Jantar temático italiano', price: 447.81, category: 'Lua de Mel', image: 'https://images.unsplash.com/photo-1498579150354-977475b7ea0b?q=80&w=600&auto=format&fit=crop' },
    ...
    { id: 12, name: 'Curtir uma noite de balada', price: 630.93, category: 'Lua de Mel', image: 'https://images.unsplash.com/photo-1571741140674-8949ca7df2a7?q=80&w=600&auto=format&fit=crop' },
